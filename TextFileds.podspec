#
#  Be sure to run `pod spec lint TextFileds.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "qiancheng"
  # s.authors            = { "qiancheng" => "qianc@zcitc.com" }
  # s.social_media_url   = "http://twitter.com/qiancheng"
